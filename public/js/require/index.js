...
(function($){
	...
	$.fn.tinyscrollbar_update = function(sScroll) { return this.each(function() { $(this).data('tsb').update(sScroll); }); };
	$.fn.tinyscrollbar_offset = function() { return $(this).data('tsb').offset(); };
	
	function Scrollbar(root, options){
		var oSelf = this;
		var oWrapper = root;
		var oViewport = { obj: $('> .viewport', root) };
		var oContent = { obj: $('> .overview', oViewport.obj) };
		var oScrollbar = { obj: $('> .scrollbar', root) };
		var oTrack = { obj: $('> .track', oScrollbar.obj) };
		var oThumb = { obj: $('> .thumb', oTrack.obj) };
